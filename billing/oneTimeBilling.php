...
// $query = "SELECT * FROM billings WHERE shop_url='" . $shopify->get_url() . "' ORDER BY id DESC LIMIT 1";
...
//             name: "Gigl One-Time Charge"
//             price: { amount: 199.99 currencyCode: NGN }
//             test: true
//             returnUrl: "https://' . $shopify->get_url() . '/admin/apps/gigl"
//             ) {
//                 appPurchaseOneTime {
//                     id
//                 }
