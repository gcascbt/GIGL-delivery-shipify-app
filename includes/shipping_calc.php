...
//     print_r(true); // Print the array contents
...
// include_once('gigl_shipping_api.php');
...
//    $parameters['shop']= str_replace($replace_all,"",'https://gigl-test-store.myshopify.com/');//$request['referring_site']
...
//     $actualCost = (isset($cost['Object']['DeliveryPrice']) ? $cost['Object']['DeliveryPrice'] * 100 : 8000.00);
    
    
//     // $rates = [
//     //     [
//     //         'service_name' => 'GIG-Logistics-Shipping', // Name of the shipping service
//     //         'service_code' => 'standard', // Unique code for the service
//     //         'total_price' => number_format($actualCost),//$shippingCost, // Shipping cost for the item
